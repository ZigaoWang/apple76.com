...
interface WWDCPageProps {
  params: { key: string[] };
}

export default async function WWDCPreviewPage({ params }: WWDCPageProps) {
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center p-8">
      <div className="max-w-2xl w-full flex flex-col items-center">
        <h1 className="text-3xl font-bold mb-6">WWDC Memorabilia Preview</h1>
